...
class ContactController extends BaseController
{
    ...
    {
        $contact = new Contact();
        $contact->setSource("Groupes, CE et clollectivités");
        ...
        if($form->isValid()){
            ...
            return $this->redirect($this->generateUrl("zpb_sites_ce_contact"));
        }


        return $this->getView("ZPBSitesCEBundle:Contact:index.html.twig", $request, ["form"=>$form->createView()]);
    }
} 
