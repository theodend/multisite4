...
class ContactController extends BaseController
{
    public function indexAction(Request $request)
    {
        ...
        if($form->isValid()){
            ...
            return $this->redirect($this->generateUrl("zpb_sites_sco_contact"));
        }
        return $this->getView("ZPBSitesScoBundle:Contact:index.html.twig", $request, ["form"=>$form->createView()]);
    }
} 
