...
class loadPageZoo1 extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    /**
    ...
    */
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $page4 = new Page();
        $page4->setName('zoo:pratique:animations')->setSite('zoo')->setTitle('Spectacles et animations')->setRoute('zpb_sites_zoo_utils_animations_shows')->setParent($page1)->setUrl($this->container->get('router')->generate('zpb_sites_zoo_utils_animations_shows',[],false));
        ...
        $page23 = new Page();
        $page23->setName('zoo:rules:rules')->setSite('zoo')->setTitle('Règlement intérieur')->setRoute('zpb_sites_zoo_rules')->setParent($page1)->setUrl($this->container->get('router')->generate('zpb_sites_zoo_rules',[],false));
        $manager->persist($page23);
