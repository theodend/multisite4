...
class StaticPageAdd{
    ...
    modifyTable(datas:any):any{
        ...
        row.append($("<td />")
            .append("<button class='btn btn-default display-page' id='dis_page_"+ datas.id +"' data-page='"+ datas.id +"'><i class='fa fa-plus'></i></button>" ));
        row.append($("<td />")
            .append("<button class='btn btn-default delete-page' id='del_page_"+ datas.id +"' data-page='"+ datas.id +"' ><i class='fa fa-trash-o'></i></button>"));
