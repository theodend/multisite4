...
class RestaurantManager{
    ...
    private updateBtn:JQuery;
    private cancelUpdateBtn:JQuery;

    constructor(public list:JQuery,public restos:any[], options?:any){
